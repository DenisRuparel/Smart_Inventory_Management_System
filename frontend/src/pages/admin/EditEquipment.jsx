                ...
                <div className="content">
                    <div className="page-header">
                        <div className="page-title">
                            <h4>Edit Your Equipment</h4>
                            <h6>Update Your Existing Equipment Here..!</h6>
                        </div>

                        <div className="page-btn">
                            <a href="/admin/equipmentslist" className="btn btn-added"><img src="../assets/img/icons/eye.svg" alt="img" className="me-1" />Show List Of Equipments</a>
                        </div>
                    </div>
